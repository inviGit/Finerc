...
@Composable
fun EditTransactionScreen1(transactionId: Long, navController: NavHostController) {
    ...
    // Form validation
    val isFormValid = place.isNotBlank() &&
            bankName.isNotBlank() &&
            amount.isNotBlank() &&
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            OutlinedTextField(
                                ...
                                leadingIcon = {
                                    Icon(Icons.Filled.Place, contentDescription = "Place", tint = Color(0xFF00D4AA))
                                },
                                singleLine = true,
                                modifier = Modifier.fillMaxWidth(),
                                colors = OutlinedTextFieldDefaults.colors(
                            ...
                            OutlinedTextField(
                                ...
                                leadingIcon = {
                                    Icon(Icons.Filled.CurrencyRupee, contentDescription = "Amount", tint = Color(0xFF00D4AA))
                                },
                                singleLine = true,
                            ...
                            OutlinedTextField(
                                ...
                                leadingIcon = {
                                    Icon(Icons.Filled.AccountBalance, contentDescription = "Bank", tint = Color(0xFF00D4AA))
                                },
                                singleLine = true,
                                modifier = Modifier.fillMaxWidth(),
                                colors = OutlinedTextFieldDefaults.colors(
                        ...
                        Column(
                            ...
                            ExposedDropdownMenuBox(
                                ...
                                OutlinedTextField(
                                    ...
                                    leadingIcon = {
                                        Icon(Icons.Default.Category, contentDescription = null, tint = Color(0xFF00D4AA))
                                    },
                                    trailingIcon = {
                                        Icon(
                            ...
                            ExposedDropdownMenuBox(
                                ...
                                OutlinedTextField(
                                    value = transactionType.name.lowercase().replaceFirstChar { it.uppercase() },
                                    onValueChange = {},
                                    readOnly = true,
                                    label = { Text("Transaction Type") },
                                    leadingIcon = {
                                        Icon(Icons.Default.SwapHoriz, contentDescription = null, tint = Color(0xFF00D4AA))
                                    },
                                    trailingIcon = {
                                        Icon(
                                ...
                                ExposedDropdownMenu(
                                    ...
                                    SMSType.entries.forEach { type ->
                                        DropdownMenuItem(
                                            ...
                                            modifier = Modifier.background(
                                                if (type == transactionType) Color(0xFF00D4AA).copy(alpha = 0.1f)
                                                else Color.Transparent
                                            )
                                        )
                                    }
...
fun EnhancedBulkUpdateDialog1(
    ...
    LaunchedEffect(selectedMonth, selectedYear) {
        if (showBulkUpdateDialog) {
            ...
            try {
                val txns = repo.getMessagesForMonth(LocalDate.now().year, LocalDate.now().monthValue)
                        ...
                        Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                            ...
                            Row(
                                ...
                                Row(verticalAlignment = Alignment.CenterVertically) {
                                    TextButton(
                                        onClick = {
                                            bulkUpdateSelected = if (bulkUpdateSelected.size == bulkUpdateTransactions.size) {
                                                emptySet()
                                            } else {
                            ...
                            LazyColumn (
                                ...
                                items(bulkUpdateTransactions) { txn ->
                                    Card(
                                        ...
                                        colors = CardDefaults.cardColors(
                                            containerColor = if (bulkUpdateSelected.contains(txn.id))
                                            ...
                                            Column(
                                                ...
                                                Row(
                                                    ...
                                                    Text(
                                                        ...
                                                        style = MaterialTheme.typography.bodyMedium,
                                                        fontWeight = FontWeight.Bold,
                                                        color = if (txn.transactionType == SMSType.SENT)
